...
function printHelp() {
  console.log(
    [
      ...
      '  /reviewp @prd.md',
      '    Review an existing local PRD file directly from the first input prompt',
      '  /reviewd @design.md',
      '    Review an existing local technical design file directly from the first input prompt',
      '',
      'Outputs:',
